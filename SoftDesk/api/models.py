...
class Contributors(models.Model):
    ...
    project_id = models.ForeignKey('api.Projects', on_delete=models.CASCADE, related_name='contributors')
...
class Issues(models.Model):
    ...
    project_id = models.ForeignKey('api.Projects', on_delete=models.CASCADE, related_name='issues')
...
class Comments(models.Model):
    ...
    issue_id = models.ForeignKey('api.Issues', on_delete=models.CASCADE, related_name='comments')
    created_time = models.DateTimeField(auto_now_add=True)
